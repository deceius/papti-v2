...
class FillPermissionsForCompanyHistory extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForCompanyHistory constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            ...
            'admin.company-history.index',
            'admin.company-history.create',
            'admin.company-history.show',
            'admin.company-history.edit',
            'admin.company-history.delete',
            'admin.company-history.bulk-delete',
        ]);
