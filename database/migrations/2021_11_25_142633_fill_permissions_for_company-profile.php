...
class FillPermissionsForCompanyProfile extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForCompanyProfile constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            ...
            'admin.company-profile.create',
            'admin.company-profile.show',
            'admin.company-profile.edit',
            'admin.company-profile.delete',
            'admin.company-profile.bulk-delete',
        ]);
