...
class FillPermissionsForProductApplication extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForProductApplication constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.product-application',
            'admin.product-application.index',
            'admin.product-application.create',
            'admin.product-application.show',
            'admin.product-application.edit',
            'admin.product-application.delete',
            'admin.product-application.bulk-delete',
        ]);
