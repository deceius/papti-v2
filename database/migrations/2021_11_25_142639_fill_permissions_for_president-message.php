...
class FillPermissionsForPresidentMessage extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForPresidentMessage constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            ...
            'admin.president-message.index',
            'admin.president-message.create',
            'admin.president-message.show',
            'admin.president-message.edit',
            'admin.president-message.delete',
            'admin.president-message.bulk-delete',
        ]);
