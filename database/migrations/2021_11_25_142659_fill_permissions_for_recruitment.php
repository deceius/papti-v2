...
class FillPermissionsForRecruitment extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForRecruitment constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.recruitment',
            'admin.recruitment.index',
            'admin.recruitment.create',
            'admin.recruitment.show',
            'admin.recruitment.edit',
            'admin.recruitment.delete',
            'admin.recruitment.bulk-delete',
        ]);
