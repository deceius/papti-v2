...
class FillPermissionsForTechnology extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForTechnology constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.technology',
            'admin.technology.index',
            'admin.technology.create',
            'admin.technology.show',
            'admin.technology.edit',
            'admin.technology.delete',
            'admin.technology.bulk-delete',
        ]);
