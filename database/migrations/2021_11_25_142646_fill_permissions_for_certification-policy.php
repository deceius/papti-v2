...
class FillPermissionsForCertificationPolicy extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForCertificationPolicy constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.certification-policy',
            'admin.certification-policy.index',
            'admin.certification-policy.create',
            'admin.certification-policy.show',
            'admin.certification-policy.edit',
            'admin.certification-policy.delete',
            'admin.certification-policy.bulk-delete',
        ]);
