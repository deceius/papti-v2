...
<div class="card-header">
    <i class="fa fa-comment"></i> [EN] IMS Policy
</div>
...
<div class="form-group row align-items-center" :class="{'has-danger': errors.has('en_ims'), 'has-success': fields.en_ims && fields.en_ims.valid }">
    ...
    <div :class="isFormLocalized ? 'col-md-12' : 'col-md-12'">
        <div>
            <wysiwyg v-model="form.en_ims" v-validate="'required'" id="text" name="text" :config="mediaWysiwygConfig" />
        </div>
...
<div class="card-header">
    <i class="fa fa-comment"></i> [JP] IMS Policy
</div>
...
<div class="form-group row align-items-center" :class="{'has-danger': errors.has('jp_ims'), 'has-success': fields.jp_ims && fields.jp_ims.valid }">
    ...
    <div :class="isFormLocalized ? 'col-md-12' : 'col-md-12'">
        <div>
            <wysiwyg v-model="form.jp_ims" v-validate="'required'" id="text" name="text" :config="mediaWysiwygConfig" />
        </div>
...
<div class="card-header">
    <i class="fa fa-comment"></i> [EN] ISO Certification
</div>
...
<div class="form-group row align-items-center" :class="{'has-danger': errors.has('en_iso'), 'has-success': fields.en_iso && fields.en_iso.valid }">
    ...
    <div :class="isFormLocalized ? 'col-md-12' : 'col-md-12'">
        <div>
            <wysiwyg v-model="form.en_iso" v-validate="'required'" id="text" name="text" :config="mediaWysiwygConfig" />
        </div>
...
<div class="card-header">
    <i class="fa fa-comment"></i> [JP] ISO Certification
</div>
...
<div class="form-group row align-items-center" :class="{'has-danger': errors.has('jp_iso'), 'has-success': fields.jp_iso && fields.jp_iso.valid }">
    ...
    <div :class="isFormLocalized ? 'col-md-12' : 'col-md-12'">
        <div>
            <wysiwyg v-model="form.jp_iso" v-validate="'required'" id="text" name="text" :config="mediaWysiwygConfig" />
        </div>
