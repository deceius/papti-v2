                    ...
                    <div class="card-body" v-cloak>
                        <div class="card-block">
                            ...
                            <table class="table table-hover table-listing">
                                <thead>
                                    <tr>
                                        ...
                                        <th is='sortable' :column="'id'">{{ trans('admin.visitor.columns.id') }}</th>
                                        <th is='sortable' :column="'country_code'">{{ trans('admin.visitor.columns.country_code') }}</th>
                            ...
                            <div class="no-items-found" v-if="!collection.length > 0">
                                ...
                                <a class="btn btn-primary btn-spinner" href="{{ url('admin/visitors/create') }}" role="button"><i class="fa fa-plus"></i>&nbsp; {{ trans('admin.visitor.actions.create') }}</a>
                            </div>
                        </div>
                    </div>
                </div>
