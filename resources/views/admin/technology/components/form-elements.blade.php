...
<div class="form-group row align-items-center" :class="{'has-danger': errors.has('en_title'), 'has-success': fields.en_title && fields.en_title.valid }">
    <label for="en_title" class="col-form-label text-md-right" :class="isFormLocalized ? 'col-md-4' : 'col-md-2'">{{ trans('admin.technology.columns.en_title') }}</label>
        <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-8'">
        <input type="text" v-model="form.en_title" v-validate="'required'" @input="validate($event)" class="form-control" :class="{'form-control-danger': errors.has('en_title'), 'form-control-success': fields.en_title && fields.en_title.valid}" id="en_title" name="en_title" placeholder="{{ trans('admin.technology.columns.en_title') }}">
...
<div class="form-group row align-items-center" :class="{'has-danger': errors.has('en_description'), 'has-success': fields.en_description && fields.en_description.valid }">
    <label for="en_description" class="col-form-label text-md-right" :class="isFormLocalized ? 'col-md-4' : 'col-md-2'">{{ trans('admin.technology.columns.en_description') }}</label>
    <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-8'">
        <div>
...
<div class="form-group row align-items-center" :class="{'has-danger': errors.has('jp_title'), 'has-success': fields.jp_title && fields.jp_title.valid }">
    <label for="jp_title" class="col-form-label text-md-right" :class="isFormLocalized ? 'col-md-4' : 'col-md-2'">{{ trans('admin.technology.columns.jp_title') }}</label>
        <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-8'">
        <input type="text" v-model="form.jp_title" v-validate="'required'" @input="validate($event)" class="form-control" :class="{'form-control-danger': errors.has('jp_title'), 'form-control-success': fields.jp_title && fields.jp_title.valid}" id="jp_title" name="jp_title" placeholder="{{ trans('admin.technology.columns.jp_title') }}">
...
<div class="form-group row align-items-center" :class="{'has-danger': errors.has('jp_description'), 'has-success': fields.jp_description && fields.jp_description.valid }">
    <label for="jp_description" class="col-form-label text-md-right" :class="isFormLocalized ? 'col-md-4' : 'col-md-2'">{{ trans('admin.technology.columns.jp_description') }}</label>
    <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-8'">
        <div>
